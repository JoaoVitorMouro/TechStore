...
//Rotas da aplicação
//Rotas de  livros
app.use(produtoRoutes); //Usar no formato que estava antes...(Sem um nome padrao inicial)
app.use(pedidoRoutes); //Usar no formato que estava antes...(Sem um nome padrao inicial)
app.use(categoriaRoutes); //Usar no formato que estava antes...(Sem um nome padrao inicial)
